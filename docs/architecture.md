...
- Static SEO guides live in `app/public/guides/` and are generated by `scripts/generate-guides.mjs`.
- Success, fail, and kill rules for that bet: [`docs/seo-watch.md`](seo-watch.md).
